...
function DualCertificate2() {
  ...
  const handleDownloadLeft = () => {
    ...
    pdf.save('STSDSD_VERIFICATION.pdf');
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex items-center justify-between px-4 py-4 bg-[#0b2545] text-white shadow-md min-h-[70px]">
        ...
        <div className="flex gap-4 items-center">
          ...
          <button onClick={() => navigate('/dual-certificate-3')} className="hover:underline flex items-center gap-1 text-sm">
